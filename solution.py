...
# ─────────────────────────────────────────────
print("Loading data...")
train = pd.read_csv('/Users/riturajadhikary/Desktop/FlipkartGrid/train.csv')
test  = pd.read_csv('/Users/riturajadhikary/Desktop/FlipkartGrid/test.csv')
...
for fold, (tr_idx, val_idx) in enumerate(kf.split(X)):
    ...
    print(f"  Fold {fold+1}: R²={r2:.5f}  score≈{max(0,100*r2):.2f}")

r2_a = r2_score(y, oof_a)
print(f"HGB-A  OOF R²={r2_a:.5f}  →  {max(0,100*r2_a):.2f}/100")
...
print(f"HGB-B  OOF R²={r2_b:.5f}  →  {max(0,100*r2_b):.2f}/100")
...
print(f"ExtraT OOF R²={r2_c:.5f}  →  {max(0,100*r2_c):.2f}/100")
...
out_path   = '/Users/riturajadhikary/Desktop/FlipkartGrid/submission.csv'
submission.to_csv(out_path, index=False)

print(f"\n✅  Submission saved → {out_path}")
print(submission.head(10).to_string())
print(f"\n🏆  Predicted hackathon score ≈ {max(0, 100*blend_r2):.2f} / 100")
